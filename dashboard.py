...
app.layout=html.Div(children=[
    ...
    html.Div([
        ...
        dcc.Dropdown(options=dropdown_options,value='Select Statistics',id='dropdown-statistics',placeholder='Select a report type',
                     style={'width':'80%','padding':'3px','font-size':'20px','textAlign':'center'})
    ]),
    html.Div([
        html.Label("Select Year:"),
        dcc.Dropdown(options=[{'label': i, 'value': i} for i in year_list],value='Select-year',placeholder='Select-year',id='select-year',
                     style={'width':'80%','padding':'3px','font-size':'20px','textAlign':'center'})
    ]),
    html.Div([
    ...
    if selected_statistics == 'Recession Period Statistics':
        ...
        R_chart1 = dcc.Graph(
            figure=px.line(yearly_rec, 
                x='Year',
                y='Automobile_Sales',
                title="Automobile Sales Fluctuations over the Years"))
